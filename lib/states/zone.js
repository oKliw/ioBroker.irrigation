...
function Zone(adapter, zoneID) {
    ...
    this.humidity = new State(adapter, zoneID + '.humidity', true);
    this.present = new State(adapter, zoneID + '.present', true);
    this.isScheduled = new State(adapter, zoneID + '.isScheduled', true);
    this.minutes = new State(adapter, zoneID + '.minutes', true);
    this.evapotranspiration = new State(adapter, zoneID + '.evapotranspiration', true, adapter.log.debug);
    this.temperature = new State(adapter, zoneID + '.temperature', true);
    this.isRunning = new State(adapter, zoneID + '.isRunning', true);
};
