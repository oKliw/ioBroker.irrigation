...
function Zone(adapter, zoneID) {
    ...
    this.isSeedTime = new State(adapter, this.id + '.isSeedTime', true);
}
...
Zone.prototype.create = function() {
    ...
    this.evapotranspiration.create({
        ...
        native: {},
        type: 'state'
    }, true, this.evapotranspiration.value || 0);
    ...
    this.present.create({
        ...
        native: {},
        type: 'state'
    }, true, this.present.value || this.settings.required.value);
