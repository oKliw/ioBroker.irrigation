...
function ZoneSettings(adapter, id) {
    ...
    this.isSeedTime = new State(adapter, this.id + '.isSeedTime', false);
}
...
ZoneSettings.prototype.create = function() {
    ...
    this.temperature.create({
        common: {
          ...
          native: {},
          type: 'state'
    }, true, this.temperature.value || 35);
    ...
    this.isAutomatic.create({
        ...
        native: {},
        type: 'state'
    }, true, this.isAutomatic.value || true);
    ...
    this.isSeedTime.create({
        ...
        native: {},
        type: 'state'
    }, true, this.isSeedTime.value || false);
};
