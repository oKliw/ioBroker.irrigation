...
function ZoneController(adapter, zone) {
    ...
    this.zone.settings.isSeedTime.onUpdate(function () {
        self.calculate();
    });
}
...
ZoneController.prototype.isLow = function() {
    if(this.zone.settings.isSeedTime.value === true) {
        return this.zone.humidity.value <= 90.0;
    } else {
        return this.zone.humidity.value <= this.zone.settings.trigger.value;
    }
};
